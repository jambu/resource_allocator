...
def pick_max_weight(items, min_value):
  ...
  ''' 
    This function helps the user pick a maximum weight for the given min_value and items.
  '''
  
  #return 5000
  
  # Experimental: pick the element with poor values per unit weight ratio and
  ...
  #non of the weights are below or equal to the expected weight
...
def calculate_cost(items, max_weight, min_value):
  ...
  '''
    ...
    but there has to be a minimum value expected specified otherwise for the terminating condition.
